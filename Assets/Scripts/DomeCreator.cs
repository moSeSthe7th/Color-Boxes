...
public class DomeCreator : MonoBehaviour {

    //public GameObject hollowFill; // assign before object pooling
    //public GameObject levelHollow;

    //MeshFilter[] cylinderMeshesFilter;
    //MeshFilter[] levelUpClyinderFilter;
    Mesh cylinderMeshes;

    private void Awake()
    {
        //hollowFill = GameObject.FindWithTag("HollowFill");
        //levelHollow = GameObject.FindWithTag("LevelHollows");

        //cylinderMeshesFilter = hollowFill.gameObject.GetComponentsInChildren<MeshFilter>();
        //levelUpClyinderFilter = levelHollow.gameObject.GetComponentsInChildren<MeshFilter>();
        ...
        this.GetComponent<MeshFilter>().mesh = cylinderMeshes;
        this.GetComponent<MeshCollider>().sharedMesh = cylinderMeshes;
     /*   for (int x = 0; x < cylinderMeshesFilter.Length; x++)
        {
            cylinderMeshesFilter[x].mesh = cylinderMeshes;
            levelUpClyinderFilter[x].mesh = cylinderMeshes;
        }*/
    }
